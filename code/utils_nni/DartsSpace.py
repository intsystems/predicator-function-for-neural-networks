...
from utils_nni.nn import DropPath
from utils_nni.pretrained import load_pretrained_weight
...
class NDS_with_CIFAR100(ModelSpace):
    __doc__ = """
...
class DARTS_with_CIFAR100(NDS_with_CIFAR100):
