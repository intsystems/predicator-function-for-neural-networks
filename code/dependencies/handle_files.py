...
def collect_and_match(
    ...
    for pair_index, (arch_dir, weight_dir) in enumerate(pairs, start=1):
        ...
        for local_idx, id_ in enumerate(matched_ids, start=1):
            ...
            weight_dest = unique_path(dst_weights / f"model_{new_id}{weight_map[id_].suffix}")
...
collect_and_match(
    [("output/trained_models_archs_1", "best_models/models_pth_1"), ("output/trained_models_archs_2", "best_models/models_pth_2")],
    "datasets/cifar100",
)
